...
def export_data_to_big_query(df):
    """
    Function to export production facts data to BigQuery.
    
    Args:
        df: pandas DataFrame containing production facts data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.fact_production"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_production_facts import load_from_google_cloud_storage
