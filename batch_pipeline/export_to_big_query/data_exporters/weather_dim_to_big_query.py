...
def export_data_to_big_query(df):
    """
    Function to export weather dimension data to BigQuery.
    
    Args:
        df: pandas DataFrame containing weather dimension data
    """
    if df.empty:
...
if __name__ == "__main__":
    ...
    from data_loaders.load_weather_dimension import load_from_google_cloud_storage
