...
def export_data_to_big_query(df):
    """
    Function to export soil dimension data to BigQuery.
    
    Args:
        df: pandas DataFrame containing soil dimension data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.dim_soil"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_soil_dimension import load_from_google_cloud_storage
