...
def export_data_to_big_query(df):
    """
    Function to export yield facts data to BigQuery.
    
    Args:
        df: pandas DataFrame containing yield facts data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.fact_yield"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_yield_facts import load_from_google_cloud_storage
