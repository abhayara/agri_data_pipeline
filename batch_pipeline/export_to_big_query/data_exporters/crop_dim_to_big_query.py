...
def export_data_to_big_query(df):
    """
    Function to export crop dimension data to BigQuery.
    
    Args:
        df: pandas DataFrame containing crop dimension data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.dim_crop"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_crop_dimension import load_from_google_cloud_storage
