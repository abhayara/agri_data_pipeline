...
def export_data_to_big_query(df):
    """
    Function to export sustainability facts data to BigQuery.
    
    Args:
        df: pandas DataFrame containing sustainability facts data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.fact_sustainability"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_sustainability_facts import load_from_google_cloud_storage
