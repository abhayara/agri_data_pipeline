...
def export_data_to_big_query(df):
    """
    Function to export farm dimension data to BigQuery.
    
    Args:
        df: pandas DataFrame containing farm dimension data
    """
    if df.empty:
    ...
    table_id = f"{project_id}.{dataset_id}.dim_farm"
...
if __name__ == "__main__":
    ...
    from data_loaders.load_farm_dimension import load_from_google_cloud_storage
